                ...
                case 3:
                    ...
                    while (true) {
                        ...
                        if (productoSeleccionadoObj.getStock() > 0) {
                            System.out.print("¿Desea aplicar la promoción para este producto? (s/n): ");// Aqui pregunto si desea o no la promocion el cual va al metodo factura y se le añade o no 
                            String aplicarPromo = tc.nextLine();

                            boolean aplicarPromocion = aplicarPromo.equalsIgnoreCase("s");
                            ...
                            factura.agregarProducto(productoSeleccionadoObj, aplicarPromocion);
